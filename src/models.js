...
export function PKFunctions(conversionFactor = 1.0) {
    return {
        ...
        'EUn im lyh': (t, dose, steadystate=false, T=0.0) => { return e2Curve3C(t, conversionFactor * dose, ...PKParameters['EUn im lyh'], 0.0, 0.0, steadystate, T); },
...
export function PKRandomFunctions(conversionFactor = 1.0) {
    return {
        ...
        'EUn im lyh': (t, dose, steadystate=false, T=0.0, idx=null) => { return e2Curve3C(t, conversionFactor * dose, ...randomMCMCSample('EUn im lyh', idx), 0.0, 0.0, steadystate, T); },
